...
type V1ContractsGetHead = {
  ...
  response: MakeTuyauResponse<
    import('../app/controllers/contracts_controller.js').default['getContractsPaginated']
  >
}
type V1ContractsPost = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('../app/validators/contract.js'))['createContractValidator']>
  >
  response: MakeTuyauResponse<
    import('../app/controllers/contracts_controller.js').default['createContract']
  >
}
type V1ContractsCreatedinlast12monthsGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/contracts_controller.js').default['getContractsCreatedInLast12Months']
  >
}
type V1ContractsEndingin30daysCountGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/contracts_controller.js').default['getContractsQuantityEndingIn30Days']
  >
}
type V1ContractsActiveCountGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/contracts_controller.js').default['getActiveContractsQuantity']
  >
}
type V1InventoryClinicItemsPost = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('../app/validators/item.js'))['createItemValidator']>
  >
  response: MakeTuyauResponse<
    import('../app/controllers/inventory_controller.js').default['createItem']
  >
}
type V1InventoryClinicItemsIdAddPost = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('../app/validators/item.js'))['changeItemQuantityValidator']>
  >
  response: MakeTuyauResponse<
    import('../app/controllers/inventory_controller.js').default['increaseItemQuantity']
  >
}
type V1InventoryClinicItemsIdWithdrawPost = {
  ...
  >
  response: MakeTuyauResponse<
    import('../app/controllers/inventory_controller.js').default['decreaseItemQuantity']
  >
}
type V1InventoryClinicItemsMoreutilizedPost = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/inventory_controller.js').default['moreUtilizedItems']
  >
}
type V1InventoryClinicItemsNeedingreplacementGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/inventory_controller.js').default['itemsNeedingReplacement']
  >
}
type V1InventoryClinicInventoryvalueGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/inventory_controller.js').default['inventoryValue']
  >
}
type V1InventoryClinicInventoryquantityGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/inventory_controller.js').default['inventoryQuantity']
  >
}
type V1InventoryClinicItemsGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/inventory_controller.js').default['getClinicItems']
  >
}
type V1InventoryClinicItemsMostusedGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/inventory_controller.js').default['getItemsWithMostTransactionsWithinLast12Months']
  >
}
type V1InventoryClinicItemsCategoriesGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/inventory_controller.js').default['getCategories']
  >
}
type V1PurchaserequestsClinicGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/purchase_requests_controller.js').default['getClinicPurchaseRequests']
  >
}
type V1PurchaserequestsClinicPost = {
  request: MakeTuyauRequest<
    InferInput<
      (typeof import('../app/validators/purchase_request.js'))['newPurchaseRequestValidator']
    >
  >
  response: MakeTuyauResponse<
    import('../app/controllers/purchase_requests_controller.js').default['newPurchaseRequest']
  >
}
type V1PurchaserequestsIdClinicReceivedPost = {
  request: MakeTuyauRequest<
    InferInput<
      (typeof import('../app/validators/purchase_request.js'))['clinicReceivedPurchaseRequestValidator']
    >
  >
  response: MakeTuyauResponse<
    import('../app/controllers/purchase_requests_controller.js').default['clinicReceivedPurchaseRequest']
  >
}
type V1PurchaserequestsIdClinicUploadinvoicePost = {
  request: MakeTuyauRequest<
    InferInput<
      (typeof import('../app/validators/purchase_request.js'))['clinicUploadInvoiceValidator']
    >
  >
  response: MakeTuyauResponse<
    import('../app/controllers/purchase_requests_controller.js').default['clinicUploadInvoice']
  >
}
type V1PurchaserequestsIdClinicDelete = {
  request: MakeTuyauRequest<
    InferInput<
      (typeof import('../app/validators/purchase_request.js'))['clinicDeletePurchaseRequestValidator']
    >
  >
  response: MakeTuyauResponse<
    import('../app/controllers/purchase_requests_controller.js').default['clinicDeletePurchaseRequest']
  >
}
type V1PurchaserequestsIdClinicInvoicesignedurlGetHead = {
  request: MakeTuyauRequest<
    InferInput<
      (typeof import('../app/validators/purchase_request.js'))['getInvoiceSignedUrlValidator']
    >
  >
  response: MakeTuyauResponse<
    import('../app/controllers/purchase_requests_controller.js').default['getInvoiceSignedUrl']
  >
}
type V1ItemsuppliersClinicGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/item_suppliers_controller.js').default['getClinicSuppliers']
  >
}
type ApiLoginPost = {
  request: unknown
  response: MakeTuyauResponse<import('../app/controllers/login_controller.js').default['login']>
}
type ApiLogoutPost = {
  request: unknown
  response: MakeTuyauResponse<import('../app/controllers/login_controller.js').default['logout']>
}
type ApiUsersPost = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('../app/validators/user.js'))['createUserValidator']>
  >
  response: MakeTuyauResponse<
    import('../app/controllers/users_controller.js').default['createUser']
  >
}
type InventarioGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/inertia/inventory_controller.js').default['handle']
  >
}
type InventarioNovoitemGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/inertia/add_inventory_item_controller.js').default['handle']
  >
}
type SolicitacoesDeCompraGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/inertia/purchase_requests_controller.js').default['handle']
  >
}
